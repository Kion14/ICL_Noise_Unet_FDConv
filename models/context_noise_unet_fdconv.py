...
# =========================================================
# FDConv import from external Snellius path
# =========================================================
...
def FDConv2d(
    ...
    """Small wrapper so FDConv can be used like nn.Conv2d in this file."""
    return FDConv(
...
class UNet_Context(nn.Module):
    def __init__(self, in_channels=1,noise_maps=False):
        super(UNet_Context, self).__init__()
...
class ContextNoiseUNet(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.unet1 = UNet_Context(in_channels=3)
